...
<template>
  <section>
    <div class="mb-6">
      <p class="font-mono text-[0.65rem] tracking-[0.2em] text-primary uppercase">Sauvegardés</p>

      <h2 class="mt-1 font-display text-2xl font-bold text-ink">Mes favoris</h2>
    ...
    >
      <p class="font-display text-lg font-bold text-ink">Aucun favori</p>
